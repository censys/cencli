...
type orgBoundFreeCreditsError struct{}

func (e *orgBoundFreeCreditsError) Error() string {
	return "you are logged in to an organization, which cannot access free user credits. " +
		"Run 'censys org credits' to see organization credits, or run 'censys auth logout' " +
		"and 'censys auth login' without selecting an organization to access your free account"
}

func (e *orgBoundFreeCreditsError) Title() string {
	return "Free Credits Unavailable"
}

func (e *orgBoundFreeCreditsError) ShouldPrintUsage() bool {
	return false
}

func NewOrgBoundFreeCreditsError() CencliError {
	return &orgBoundFreeCreditsError{}
}

type freeAccountOrgError struct{}

func (e *freeAccountOrgError) Error() string {
	return "you are logged in to your free account, which cannot access organizations. " +
		"Run 'censys auth logout' and 'censys auth login', selecting the organization, to access it"
}

func (e *freeAccountOrgError) Title() string {
	return "Organization Access Unavailable"
}

func (e *freeAccountOrgError) ShouldPrintUsage() bool {
	return false
}

func NewFreeAccountOrgError() CencliError {
	return &freeAccountOrgError{}
}
