...
func (c *AssignCommand) PreRun(cmd *cobra.Command, args []string) cenclierrors.CencliError {
	...
	// Don't call AssetType(): mixed types are fine here (each assignment is
...
func (c *AssignCommand) gatherRawAssets(cmd *cobra.Command, args []string) ([]string, cenclierrors.CencliError) {
