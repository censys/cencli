...
type Service interface {
	...
	GetOrganizationCreditDetails(ctx context.Context, orgID uuid.UUID) (OrganizationCreditDetailsResult, cenclierrors.CencliError)
	// GetUserCreditDetails retrieves the credit details for the current user.
	GetUserCreditDetails(ctx context.Context) (UserCreditDetailsResult, cenclierrors.CencliError)
}
...
func (s *creditsService) GetOrganizationCreditDetails(ctx context.Context, orgID uuid.UUID) (OrganizationCreditDetailsResult, cenclierrors.CencliError) {
	res, err := s.client.GetOrganizationCreditDetails(ctx, orgID)
	if err != nil {
